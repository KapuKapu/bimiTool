...
silent! normal! zE
let s:l = 511 - ((64 * winheight(0) + 42) / 85)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 257 - ((43 * winheight(0) + 42) / 85)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
257
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 299 - ((72 * winheight(0) + 42) / 85)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
299
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 16 - ((15 * winheight(0) + 42) / 85)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
